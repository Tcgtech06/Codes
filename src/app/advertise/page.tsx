...
export default function AdvertisePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const existingSubmissions = JSON.parse(localStorage.getItem('advertiseSubmissions') || '[]');
    existingSubmissions.push(submission);
    localStorage.setItem('advertiseSubmissions', JSON.stringify(existingSubmissions));
