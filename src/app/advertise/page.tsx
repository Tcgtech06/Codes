    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-green-50 pb-20 md:pb-8">
      ...
      <div className="bg-white shadow-sm md:sticky md:top-16 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Advertise With Us</h1>
            <p className="text-gray-600 mt-2 text-sm md:text-base">Promote your business to thousands of textile industry professionals</p>
          </div>
        </div>
      </div>
