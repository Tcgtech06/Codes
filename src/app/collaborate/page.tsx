...
export default function CollaboratePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const existingSubmissions = JSON.parse(localStorage.getItem('collaborateSubmissions') || '[]');
    existingSubmissions.push(submission);
    localStorage.setItem('collaborateSubmissions', JSON.stringify(existingSubmissions));
    ...
    setTimeout(() => {
      setFormData({
        ...
        website: '', organizationType: '', collaborationType: '',
        projectDescription: '', timeline: '', budget: '', experience: '', message: ''
      });
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1e3a8a] focus:border-transparent outline-none resize-none"
                  placeholder="Describe your organization's relevant experience and past partnerships..."
                />
              </div>
