  ...
  const stories = [
    {
      ...
      subtitle: "SIHMA Presidential Launch",
      description: "SIHMA (South India Hosiery Manufacturers Association) President officially launched Knit Info",
      mobileDescription: "Launched by SIHMA President",
      details: "A visionary initiative to revolutionize the textile industry's information ecosystem and create a comprehensive networking platform.",
      mobileDetails: "Revolutionary textile industry platform",
      icon: Rocket,
    ...
    },
    {
      ...
      month: "June",
      title: "Expansion",
      subtitle: "Office Establishment",
      description: "Office opened by Head of Tripur Garments, marking our transition to a formal business entity",
      mobileDescription: "Office opened by Tripur Garments",
      details: "Strategic expansion from startup to established business, laying the foundation for nationwide operations.",
    ...
    },
    {
      ...
      subtitle: "Ministerial Endorsement",
      description: "Honorable Union Textile Minister Dhayanidhi Maran released the Knit Info Handbook",
      mobileDescription: "Minister released Knit Info Handbook",
      details: "Official government recognition and endorsement, establishing credibility at the highest national level.",
      mobileDetails: "Gained national recognition",
      icon: Handshake,
    ...
    },
    {
      ...
      subtitle: "Sri Lankan Market Entry",
      description: "Knit Info Directory successfully launched in the Sri Lankan Textile Industry",
      mobileDescription: "Launched in Sri Lankan market",
      details: "Strategic international expansion, extending our comprehensive directory services across South Asian markets.",
      mobileDetails: "Expanded internationally",
      icon: Monitor,
    ...
    },
    {
      ...
      subtitle: "7K Directory Circulation",
      description: "Successfully distributed 7,000 Knit Info Directories across all major textile hubs in India",
      mobileDescription: "7K directories distributed nationwide",
      details: "Massive distribution achievement, reaching every corner of India's textile ecosystem with comprehensive industry information.",
      mobileDetails: "Nationwide market penetration",
      icon: Smartphone,
    ...
    },
    {
      ...
      description: "Knit Info Directory mobile application launched, bringing digital transformation to the textile industry",
      mobileDescription: "Mobile app launched",
      details: "Revolutionary digital platform offering real-time connectivity, advanced search capabilities, and seamless user experience.",
      mobileDetails: "Digital transformation achieved",
      icon: Sparkles,
    ...
    },
    {
      ...
      subtitle: "MP Handbook Release",
      description: "Knit Info Handbook released by Honorable Karur MP, marking another milestone in our journey",
      mobileDescription: "Handbook released by Karur MP",
      details: "Continued parliamentary support and recognition, reinforcing our position as the industry's most trusted information resource.",
      mobileDetails: "Parliamentary endorsement",
      icon: TrendingUp,
