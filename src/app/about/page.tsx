  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Benefits & Promotional Campaign Section */}
        <div className="mt-16 mb-16">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Benefits Galore & Promotional Campaign
              </h2>
              <p className="text-lg text-gray-600">
                Comprehensive marketing and promotional strategies to maximize your business reach
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start space-x-4 p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors duration-300">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Trade Fair Participation</h3>
                  <p className="text-gray-600 text-sm">Regular participation at top textile industry trade fairs in India and neighboring Asian countries</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Direct SMS, email, electronic marketing and advertising campaign in local publications in the region</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors duration-300">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Industry Association Network</h3>
                  <p className="text-gray-600 text-sm">Copies presented to top industry trade associations for maximum exposure</p>
                </div>
              </div>

              {/* Benefit Item 4 */}
              <div className="flex items-start space-x-4 p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors duration-300">
                <div className="flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Print Media Advertising</h3>
                  <p className="text-gray-600 text-sm">Strategic advertisements in newspapers to reach wider audience</p>
                </div>
              </div>

              {/* Benefit Item 5 */}
              <div className="flex items-start space-x-4 p-4 bg-red-50 rounded-lg hover:bg-red-100 transition-colors duration-300">
                <div className="flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Tele Calling Campaign</h3>
                  <p className="text-gray-600 text-sm">Targeted tele calling to pre-identified potential customers for direct engagement</p>
                </div>
              </div>

              {/* Benefit Item 6 */}
              <div className="flex items-start space-x-4 p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors duration-300">
                <div className="flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Network Marketing</h3>
                  <p className="text-gray-600 text-sm">Active network marketing at major industry events and conferences</p>
                </div>
              </div>

              {/* Benefit Item 7 */}
              <div className="flex items-start space-x-4 p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors duration-300">
                <div className="flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Flyer Distribution</h3>
                  <p className="text-gray-600 text-sm">10,000 flyers distributed regularly to ensure maximum visibility</p>
                </div>
              </div>

              {/* Benefit Item 8 */}
              <div className="flex items-start space-x-4 p-4 bg-teal-50 rounded-lg hover:bg-teal-100 transition-colors duration-300">
                <div className="flex-shrink-0">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Personal Promotion</h3>
                  <p className="text-gray-600 text-sm">Dedicated personal promotion by our experienced marketing team</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 text-white text-center">
              <p className="text-lg font-semibold mb-2">
                Comprehensive 360° Marketing Approach
              </p>
              <p className="text-blue-100">
                We combine traditional and digital marketing strategies to ensure your business gets maximum exposure in the textile industry
              </p>
            </div>
          </div>
        </div>
